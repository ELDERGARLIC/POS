...
class DarkhastDetailsManager extends StatefulWidget {
  DarkhastDetailsManager({this.dataMap});
  final dataMap;
  @override
  _DarkhastDetailsManagerState createState() => _DarkhastDetailsManagerState();
}

class _DarkhastDetailsManagerState extends State<DarkhastDetailsManager> {
