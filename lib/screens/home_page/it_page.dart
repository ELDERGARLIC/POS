import 'package:corpapp/services/it/it_networking.dart';
...
class _ItPageState extends State<ItPage> {
  bool _darkhaste2Check = false;
  bool _darkhaste3Check = false;
  bool _darkhaste1Check = false;
  String mored = "";
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      CustomCheckBox(
                                        ...
                                        title: "درخواست 2",
                                        checkbox: Checkbox(
                                          value: _darkhaste2Check,
                                          onChanged: (value) {
                                            setState(
                                              () {
                                                _darkhaste2Check = value;
                                                if (value == true) {
                                                  _darkhaste1Check = false;
                                                  _darkhaste3Check = false;
                                                  mored = "درخواست 2";
                                                }
                                                print(mored);
                                              },
                                      ...
                                      CustomCheckBox(
                                        ...
                                        title: "درخواست ۱",
                                        checkbox: Checkbox(
                                          value: _darkhaste1Check,
                                          onChanged: (value) {
                                            setState(
                                              () {
                                                _darkhaste1Check = value;
                                                if (value == true) {
                                                  _darkhaste2Check = false;
                                                  _darkhaste3Check = false;
                                                  mored = "درخواست 1";
                                                }
                                                print(mored);
                                  ...
                                  CustomCheckBox(
                                    ...
                                    title: "درخواست 3",
                                    checkbox: Checkbox(
                                      value: _darkhaste3Check,
                                      onChanged: (value) {
                                        setState(
                                          () {
                                            _darkhaste3Check = value;
                                            if (value == true) {
                                              _darkhaste2Check = false;
                                              _darkhaste1Check = false;
                                              mored = "درخواست 3";
